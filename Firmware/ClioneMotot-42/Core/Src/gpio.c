...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, MT6816_AUX_CS_Pin|MT6816_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : IN_BM_Pin IN_BP_Pin IN_AM_Pin IN_AP_Pin
                           MT6816_AUX_CS_Pin MT6816_CS_Pin */
  ...
  /*Configure GPIO pins : BUTTON_2_Pin KEY1_Pin */
  GPIO_InitStruct.Pin = BUTTON_2_Pin|KEY1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
